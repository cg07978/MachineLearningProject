...
rbf_tts_scores = []
rbf_tts_gammas = np.linspace(0.001, 5.0, 100)
rbf_tts_cs = np.linspace(0.001, 5.0, 100)
...
linear_tts_cs = np.linspace(0.001, .47, 100)
...
plt.plot(linear_tts_cs, linear_tts_train_scores, label='No Duplicate Set LinearSVR Training Score')
plt.plot(linear_tts_cs, linear_tts_test_scores, label='No Duplicate Set LinearSVR Testing Score')
plt.legend()
plt.figure()


rbf_cv_scores = []
rbf_cv_gammas = np.linspace(0.001, 10.0, 100)
...
poly_cv_scores = []
poly_cv_gammas = np.linspace(0.001, 1, 100)
...
sigmoid_cv_scores = []
sigmoid_cv_gammas = np.linspace(0.001, 0.1, 100)
sigmoid_cv_cs = np.linspace(0.001, 0.5, 100)
...
linear_cv_scores = []
linear_cv_cs = np.linspace(0.001, 0.36, 100)

for c in linear_cv_cs:
    linear_cv_scores.append(cross_val_score(LinearSVR(C=c), X, y).mean())
    
plt.plot(linear_cv_cs, linear_cv_scores, label='No Duplicate Set LinearSVR CV Score')
plt.legend()
